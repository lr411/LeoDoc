...
\begin{thebibliography}{99}
	...
	\bibitem{crisan1} Error Bounds and Normalizing Constants for Sequential Monte Carlo in
	High Dimensions. Beskos, Alexandros , Crisan, Dan ,  Jasra, Ajay , Whiteley, Nick. (2011)
	\bibitem{crisan2} On the stability of sequential Monte Carlo methods in high dimensions. Beskos, A., Crisan, D., Jasra, A. Ann. Appl. Probab. 24 (2014), no. 4, 1396--1445. doi:10.1214/13-AAP951
	\bibitem{sequentialmcsamplersdelmoral} Sequential monte carlo samplers. Del Moral, P., Doucet, A. (2003), Condensed Matter (cond-mat) CUED-F-INFENG-443,	arXiv:cond-mat/0212648
